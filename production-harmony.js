/* Google Apps Script Web App URL — deploy apps-script/ProductionCode-Harmony.gs against
   your "me'seum製作表單 - Harmony款" spreadsheet, then paste the /exec URL here.
...
function setupSubmit() {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    if (coverCount !== MIN_COVER_FILES) {
      missing.push(`封面照片（需上傳 ${MIN_COVER_FILES} 張）`);
    }
